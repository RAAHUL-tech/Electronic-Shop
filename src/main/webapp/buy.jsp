<%-- 
    Document   : buy
    Created on : 05-Feb-2023, 12:46:19 pm
    Author     : rahul
--%>
...
<select name="sort" id="sort">
  ...
  <option value="discount">Sort by Discount</option>
        ...
        <%
                   ...
                   PreparedStatement stmt=con.prepareStatement("select id,product_name,product_description,amount,discount from product_details");
...
%>
      <% 
          Cookie uName = new Cookie("uname", uname);
