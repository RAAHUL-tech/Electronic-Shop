<%-- 
    Document   : buy_discount
    Created on : 05-Feb-2023, 5:56:19 pm
    Author     : rahul
--%>
...
<select name="sort" id="sort">
  ...
  <option value="discount" selected>Sort by Discount</option>
</select>
        ...
        <%
                   ...
                   PreparedStatement stmt=con.prepareStatement("select id,product_name,product_description,amount,discount from product_details order by discount DESC");
...
<%
                   ...
                   PreparedStatement stmt1=con1.prepareStatement("select id,product_name,product_des,amount from oldproduct");
